...
class GamesRoutes {
    ...
    config() {
        ...
        this.router.get('/:id_getOne', gamesController_1.default.getOne);
        this.router.post('/', gamesController_1.default.create);
        this.router.put('/:id_update', gamesController_1.default.update);
        this.router.delete('/:id_delete', gamesController_1.default.delete);
    }
}
